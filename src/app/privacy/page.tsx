  ...
  return (
    <div className="reveal mx-auto max-w-3xl px-4 py-14 lg:px-6">
      ...
      <div className="mt-6 space-y-4 text-sm leading-7 text-muted">
        ...
        <p>You may request correction or deletion of personal data by calling {BUSINESS.phoneDisplay}, subject to accounting and fraud-prevention retention needs.</p>
