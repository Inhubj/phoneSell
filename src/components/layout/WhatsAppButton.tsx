...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed right-4 bottom-24 z-40 inline-flex h-14 w-14 items-center justify-center overflow-hidden rounded-full bg-[#25D366] text-white shadow-[0_8px_22px_rgba(18,140,70,0.45)] transition hover:scale-105 md:bottom-6"
